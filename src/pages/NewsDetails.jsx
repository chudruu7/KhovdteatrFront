...
const MOCK_NEWS_DB = {
    'new-projection-4k': {
        ...
        summary: "Манай үзвэр театр үзэгчдэдээ хамгийн өндөр нягтралтай дүрсийг мэдрүүлэх зорилгоор 4K Laser проекц системийг шинэчиллээ.",
        date: "2023.11.20",
        ...
        content: [
            ...
            { type: 'text', value: "Шинэ проекторын давуу тал нь зөвхөн дүрсийн чанараар хязгаарлагдахгүй — эрчим хүч хэмнэлттэй, 3D үзвэрийг нүд ядраахгүйгээр үзэх боломжтой." },
        ],
